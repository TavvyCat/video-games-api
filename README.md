...
This template contains a project, `video_games`, and an app, `api`,
...
1. Replace all instances of `video_games` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `video_games` which should be renamed
...
all instances of `video_games` with your app's name.
